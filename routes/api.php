...
Route::group(['middleware'=>'auth:api'], function() {
   ...
   Route::group(['namespace'=>'StaticPage'], function(){
    ...
    Route::post('apply-record','FormController@applyRecord');
    Route::post('invite-umpire','FormController@inviteUmpire');
    Route::post('report-record','FormController@reportRecord');
    Route::post('priority-apps','FormController@priorityApps');

    Route::get('get-apply-records','FormController@getApplyRecord');
    Route::get('get-apply-rec/{id}','FormController@getApplyRecordById');
    Route::get('delete-apply-rec/{id}','FormController@deleteApplyRecord');

    Route::get('get-umpire','FormController@getInviteUmpire');
    Route::get('get-umpire/{id}','FormController@getInviteUmpireById');
    Route::get('delete-umpire/{id}','FormController@deleteUmpire');

    Route::get('get-report-record','FormController@getReportRecord');
    Route::get('get-report-record-by-id/{id}','FormController@getReportRecordById');
    Route::get('delete-report-record/{id}','FormController@deleteReportRecord');

    Route::get('get-priority-app','FormController@getPriorityApp');
    Route::get('get-priority-app-by-id/{id}','FormController@getPriorityAppById');
    Route::get('delete-priority-app/{id}','FormController@deletePriorityApp');
    Route::get('get-counts','FormController@getCountsHomePage');
